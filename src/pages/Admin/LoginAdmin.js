  ...
  return (
    <div className="relative min-h-screen flex ">
      <div className="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
        ...
        >
          <div className="absolute bg-gradient-to-b from-yellow-600 to-orange-500 opacity-75 inset-0 z-0" />
        ...
        <div className="md:flex md:items-center md:justify-center sm:w-auto md:h-full w-2/5 xl:w-2/5 p-8  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white">
          <div className="max-w-md w-full space-y-8">
            <div className="text-center">
              ...
              {authData.error && (
                <div className="text-red-500">{authData.error}</div>
              )}
            </div>
            <div className="flex items-center justify-center space-x-2">
              <span className="h-px w-16 bg-gray-200" />
              <span className="text-gray-300 font-normal">
                Login ini akan menuju ke dashboard
              </span>
              <span className="h-px w-16 bg-gray-200" />
            </div>
            <form
            ...
            >
              ...
              <div>
                <PrimaryButton
                  type="submit"
                  className="from-yellow-400 to-orange-500 hover:from-yellow-400 hover:to-orange-400"
                >
                  {loading ? (
